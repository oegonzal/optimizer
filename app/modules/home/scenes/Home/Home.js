...
class Home extends React.Component {
    ...
    renderItem({item, index, active, data}, row = false) {
        // return <Quote index={index} active={active} row={row} data={data} />
        return <Quote index={index} active={active} data={data} row={row}/>
    }
            ...
            return (
                <View style={styles.container}>
                    {/* <SortableList
                        ...
                        data={simple_data}
                        renderRow={(data) => this.renderItem(data, true)} /> */}
